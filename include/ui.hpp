...
template<typename T> T GetTypedInput(const std::string& prompt);
...
template<typename T>
SequenceWrapper<T>::SequenceWrapper(const std::string& struct_type, const std::string& type_name) 
...
template<typename T>
void SequenceWrapper<T>::Display() const {
    std::cout << "[ ";
...
template<typename T>
void SequenceWrapper<T>::DeleteElement() {
...
template<typename T>
void SequenceWrapper<T>::AccessElement() const {
...
template<typename T>
ISequenceWrapper* SequenceWrapper<T>::CreateSubsequence() const {
...
template<typename T>
ISequenceWrapper* SequenceWrapper<T>::Combine(const ISequenceWrapper* other) const {
...
template<typename T>
const std::string& SequenceWrapper<T>::GetTypeName() const {
    return data_type;
}

template<typename T>
const std::string& SequenceWrapper<T>::GetStructureName() const {
